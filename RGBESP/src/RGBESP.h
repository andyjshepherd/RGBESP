...
class RGBESP {
public:
  RGBESP(uint8_t pinR, uint8_t pinG, uint8_t pinB, uint8_t channelR = 0, uint8_t channelG = 1, uint8_t channelB = 2, uint16_t freq = 5000, uint8_t resolution = 8);
  void begin();
